...
class TemplatesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Agreement\Templates', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Agreement\Templates', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Agreement\Templates', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Agreement\Templates', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Agreement\Templates', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Agreement\Templates', $model);
    }
