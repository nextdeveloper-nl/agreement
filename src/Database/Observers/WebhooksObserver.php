...
class WebhooksObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Agreement\Webhooks', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Agreement\Webhooks', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Agreement\Webhooks', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Agreement\Webhooks', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Agreement\Webhooks', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Agreement\Webhooks', $model);
    }
