...
namespace NextDeveloper\Agreement;
 ...
 */
class AgreementServiceProvider extends AbstractServiceProvider {
    /**
     * @var bool
     */
    ...
    public function boot() {
        $this->publishes([
            __DIR__.'/../config/agreement.php' => config_path('agreement.php'),
        ], 'config');

        $this->loadViewsFrom($this->dir.'/../resources/views', 'Agreement');
...
//        $this->bootErrorHandler();
    ...
    public function register() {
        ...
        $this->registerMiddlewares('agreement');
        $this->registerRoutes();
        $this->registerCommands();

        $this->mergeConfigFrom(__DIR__.'/../config/agreement.php', 'agreement');
    }
